// cellbender_remove_background v4.0.0
// 
...
meta = [
  ...
  "build_info" : {
    "config" : "/workdir/root/repo/src/correction/cellbender_remove_background/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker|native",
    "output" : "/workdir/root/repo/target/nextflow/correction/cellbender_remove_background",
    "viash_version" : "0.9.4",
...
meta["defaults"] = [
  ...
  "container" : {
    ...
    "image" : "vsh/openpipeline/correction/cellbender_remove_background",
    "tag" : "v4.0.0"
  },
  "label" : [
    "midcpu",
