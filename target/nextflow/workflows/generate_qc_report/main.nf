...
meta = [
      ...
      "arguments" : [
        {
          "type" : "string",
          "name" : "--id",
          "description" : "The sample IDs to include in the report. If not provided,\nthe sample IDs will be extracted from the h5mu files.\n",
          "example" : [
            "sample1"
          ],
          "required" : false,
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_qc/openpipeline_qc/src/workflows/generate_qc_report/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
    "output" : "/home/runner/work/openpipeline_qc/openpipeline_qc/target/nextflow/workflows/generate_qc_report",
    "viash_version" : "0.9.7",
    "git_commit" : "67e0e481ca864ed3a1eba7f5ccc8c5ecbbd9a171",
...
include { qc } from "${meta.root_dir}/dependencies/vsh/vsh/openpipeline/v4.1.0/nextflow/workflows/qc/qc/main.nf"
include { cellbender_remove_background as cellbender_viashalias } from "${meta.root_dir}/dependencies/vsh/vsh/openpipeline/v4.1.0/nextflow/correction/cellbender_remove_background/main.nf"
