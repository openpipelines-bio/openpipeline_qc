// detect_ingestion_method build_main
// 
...
meta = [
  ...
  "test_resources" : [
    ...
    {
      "type" : "file",
      "path" : "/resources_test/cellranger/10x_5k_anticmv/5k_human_antiCMV_T_TBNK_connect_10k.h5mu"
    },
    {
      "type" : "file",
      "path" : "/resources_test/cosmx/SMI_Lung5/Lung5_Rep2_tiny.h5mu"
    },
    {
      "type" : "file",
      "path" : "/resources_test/xenium/Prime_Mouse_Ileum_tiny/Prime_Mouse_Ileum_tiny.h5mu"
    }
  ],
  "status" : "enabled",
  "scope" : {
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_qc/openpipeline_qc/src/ingestion_qc/detect_ingestion_method/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par = {
  ...
  'output_uns_ingestion_method': $( if [ ! -z ${VIASH_PAR_OUTPUT_UNS_INGESTION_METHOD+x} ]; then echo "r'${VIASH_PAR_OUTPUT_UNS_INGESTION_METHOD//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
