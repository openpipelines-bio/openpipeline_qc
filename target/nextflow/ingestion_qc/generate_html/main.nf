...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_qc/openpipeline_qc/src/ingestion_qc/generate_html/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "/home/runner/work/openpipeline_qc/openpipeline_qc/target/nextflow/ingestion_qc/generate_html",
    "viash_version" : "0.9.4",
    "git_commit" : "d64d7279e88b14e26132cb8ed784fe18059b5183",
  ...
  "package_config" : {
    ...
    "viash_version" : "0.9.4",
    "source" : "/home/runner/work/openpipeline_qc/openpipeline_qc/src",
    "target" : "/home/runner/work/openpipeline_qc/openpipeline_qc/target",
    "config_mods" : [
...
$( if [ ! -z ${VIASH_PAR_INPUT_DATA+x} ]; then echo "${VIASH_PAR_INPUT_DATA}" | sed "s#'#'\\"'\\"'#g;s#.*#par_input_data='&'#" ; else echo "# par_input_data="; fi )
$( if [ ! -z ${VIASH_PAR_INPUT_STRUCTURE+x} ]; then echo "${VIASH_PAR_INPUT_STRUCTURE}" | sed "s#'#'\\"'\\"'#g;s#.*#par_input_structure='&'#" ; else echo "# par_input_structure="; fi )
$( if [ ! -z ${VIASH_PAR_OUTPUT_QC_REPORT+x} ]; then echo "${VIASH_PAR_OUTPUT_QC_REPORT}" | sed "s#'#'\\"'\\"'#g;s#.*#par_output_qc_report='&'#" ; else echo "# par_output_qc_report="; fi )
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline_qc/ingestion_qc/generate_html",
    "tag" : "build_main"
  },
  "label" : [
    "lowmem",
